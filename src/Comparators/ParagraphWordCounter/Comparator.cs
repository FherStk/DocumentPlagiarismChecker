...
namespace DocumentPlagiarismChecker.Comparators.ParagraphWordCounter
{
    ...
    {  
        ...
        public override ComparatorMatchingScore Run(){     
            //Esta orden está destinada a mejorar el rendimiento
            ExcludeSampleExactMatches(); 
            ExcludeSamplePartialMatches(this.Left, 0.70f);  //TODO: valor de umbral debe obtenerse de la configuración; comprobar si se puede quitar
            ExcludeSamplePartialMatches(this.Right, 0.70f);  //TODO: valor de umbral debe obtenerse de la configuración; comprobar si se puede quitar
        ...
        /// <summary>
        /// Compara la muestra con el archivo y excluye los parrafos que produzcan un falso positivo.
        /// </summary>
