...
namespace DocumentPlagiarismChecker.Comparators.ParagraphWordCounter
{
    ...
    {  
        ...
        /// <summary>
        /// Compte quant de paraules i quantes vegades apareixen dins de cada paràgraf en un document, i verifica el percentatge corresponent.
        /// </summary>
        ...
        private void ExcludeSampleMatches(Document doc){
             if(this.Sample != null){                
                ...
                for(int i = 0; i < sampleScore.DetailsData.Count; i++){                    
                    ...
                    //TODO: permetent utilitzar el valor de totalMatch o la longitud + coincidències de paraules (que es fan servir per calcular la coincidència total).
