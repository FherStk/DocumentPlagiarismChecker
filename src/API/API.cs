...
namespace DocumentPlagiarismChecker
{
    ...
    public class API{
        ...
        /// <returns></returns>
        public static List<FileMatchingScore> CompareFiles(){
            //Initial Checks
        ...
        public static void WriteOutput(List<FileMatchingScore> results, DisplayLevel level = DisplayLevel.COMPARATOR){
            //TODO: must be selected by settings
            Outputs.Terminal t = new Outputs.Terminal();
            t.Write(results, level);
        }
